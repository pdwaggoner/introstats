...
for(i in 1:length(d)) { # loop over all twenty onservations and store for the ith observation of m
...
abline(a=mu, b=0, col="red") # repeat lines 5-25 to see a different distribution - one obs should be outside of the mean, given the 95% CIs we created and applied (19/20)
